...
> install it with `npm install -g @crucible/cli`.
...
dependencies (`@crucible/core-win32-x64`, `@crucible/core-darwin-x64`,
`@crucible/core-darwin-arm64`, `@crucible/core-linux-x64-gnu`, glibc only on

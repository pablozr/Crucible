...
> **Prerelease.** `@pablozrrrr/crucible-cli` `0.1.0` is not published to npm yet. Once
> published, install it with `npm install -g @pablozrrrr/crucible-cli`. Until then, use
